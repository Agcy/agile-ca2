...
**Solutions**: Surprisingly, I eventually found that creating a .coveralls.yml locally and then adding my own coveralls token allowed me to run it locally.
...
**Swagger**: As you have learnt in the web application development assignment, the json file is generated by saving the routes through postman, and then through the json to yml file function on the web and finally by uploading this yml file to Swagger Hub to get the final routes displayed.
